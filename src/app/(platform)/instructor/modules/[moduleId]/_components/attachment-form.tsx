...
interface AttachmentFormProps {
    initialData: Module & {attachments : Attachment[]}
    moduleId: string
}
...
function AttachmentForm({ initialData, moduleId }: AttachmentFormProps) {
                ...
                <>
                    ...
                    {initialData.attachments.length > 0 && (
                        <div className="space-y-2">
                            ...
                            <div key={attachment.attachmentId} className='flex items-center p-3 w-full bg-sky-100 border border-sky-200 text-sky-700 rounded-md'>
